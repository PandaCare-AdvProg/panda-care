...
public class DoctorTest {
    ...
    public void testDoctorConstructor() {
        ...
        String nik = "NIK001";
        String workingAddress = "Address1";
        String phoneNumber = "123456789";
        String specialty = "Cardiology";

        Doctor doctor = new Doctor(email, password, name, nik, workingAddress, phoneNumber, specialty);
    ...
    public void testEqualsAndHashCode() {
        Doctor doctor1 = new Doctor("doc@example.com", "pass", "John Doe", "NIK001", "Address1", "123456789", "Cardiology");
        Doctor doctor2 = new Doctor("doc@example.com", "pass", "John Doe", "NIK001", "Address1", "123456789", "Cardiology");
    ...
    public void testNotEqualsWhenDifferent() {
        ...
        Doctor doctor1 = new Doctor("doc@example.com", "pass", "John Doe", "NIK001", "Address1", "123456789", "Cardiology");
        Doctor doctor2 = new Doctor("different@example.com", "pass", "John Doe", "NIK001", "Address1", "123456789", "Cardiology");
    ...
    public void testToString() {
        Doctor doctor = new Doctor("doc@example.com", "pass", "John Doe", "NIK001", "Address1", "123456789", "Cardiology");
